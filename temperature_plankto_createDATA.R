...
filter(datetime > "2019-08-28 15:30:15", datetime < "2019-08-30 18:00:15") %>% #datetime between two dates
...
plot
ggsave(plot = plot, file = 'Fig1Temp_curves.jpeg', width = 20, height = 10)
## ------------------------------------------------------------------------------ ##
## ------------------------------------------------------------------------------ ##
